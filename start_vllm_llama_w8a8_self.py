#!/usr/bin/env python3
"""
vLLM server launcher for self-quantized Meta-Llama-3.1-8B-Instruct W8A8.
Port 8813, served-model-name Llama-3.1-8B-Instruct-W8A8-self.
Quantized via msmodelslim (W8A8_DYNAMIC INT8 + IterSmooth), 2026-09-24.
"""
import sys
import os
import asyncio
...
MODEL_DIR = "/inspire/sj-ssd3/project/project-public/s26068/agent_benchmark_test/models/Meta-Llama-3.1-8B-Instruct-W8A8-self"
...
CLI_ARGS = [
    ...
    '--quantization', 'ascend',
    '--dtype', 'auto',
    '--served-model-name', 'Llama-3.1-8B-Instruct-W8A8-self',
    '--trust-remote-code',
