#!/usr/bin/env python3
"""
Patched vLLM server launcher for Qwen3-4B-Base W8A8.
...
# ── Step 2: Define MODEL_DIR (Base W8A8) ──
MODEL_DIR = "/inspire/sj-ssd3/project/project-public/s26068/agent_benchmark_test/models/Qwen3-4B-Base-W8A8"
