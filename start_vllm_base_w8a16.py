#!/usr/bin/env python3
"""
Patched vLLM server launcher for Qwen3-4B-Base W8A16.
1. Disables AOTAutogradCache before vLLM loads.
2. Fixes maybe_update_config to always try MODEL_DIR first.
"""
import sys
import os
import asyncio
...
# ── Step 2: Define MODEL_DIR (Base W8A16) ──
MODEL_DIR = "/inspire/sj-ssd3/project/project-public/s26068/agent_benchmark_test/models/Qwen3-4B-Base-W8A16"
