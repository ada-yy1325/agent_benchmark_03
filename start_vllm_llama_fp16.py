#!/usr/bin/env python3
"""
vLLM server launcher for Meta-Llama-3.1-8B-Instruct FP16 (GPQA-Diamond test).
Port 8811, served-model-name Llama-3.1-8B-Instruct-FP16.
"""
import sys
import os
import asyncio
...
MODEL_DIR = "/inspire/sj-ssd3/project/project-public/s26068/agent_benchmark_test/models/Meta-Llama-3.1-8B-Instruct"
...
CLI_ARGS = [
    ...
    '--max-model-len', '32768',
    '--dtype', 'auto',
    '--served-model-name', 'Llama-3.1-8B-Instruct-FP16',
    '--trust-remote-code',
